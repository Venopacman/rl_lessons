...
def define_network(state_dim, n_actions):
    ...
    network.add_module('layer1', nn.Linear(state_dim[0], 30))
    network.add_module('activ_l1', nn.ReLU())
    network.add_module('layer2', nn.Linear(30, 20))
    network.add_module('activ_l2', nn.ReLU())
    network.add_module('layer3', nn.Linear(20, 10))
    network.add_module('activ_l3', nn.ReLU())
    network.add_module('layer4', nn.Linear(10, 5))
    network.add_module('activ_l4', nn.ReLU())
    network.add_module('layer5', nn.Linear(5, n_actions))
    return network
